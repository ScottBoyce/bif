...
MODULE DATE_OPERATOR_INSTRUCTION!, ONLY: DATE_OPERATOR
  ...
  TYPE DATE_OPERATOR
     ...
     GENERIC            :: INIT_DMY     => INITIALIZE_DATE_OPERATOR_DMY, INITIALIZE_DATE_OPERATOR_DMYHMS, &
                                           INITIALIZE_DATE_OPERATOR_DMYHMSdbl
     ...
     GENERIC            :: OPERATOR(+)      => DATE_OPERATOR_ADD_INT, DATE_OPERATOR_ADD_DBLE, DATE_OPERATOR_ADD_SNGL, &
                                               DATE_OPERATOR_ADD_INT_REV, DATE_OPERATOR_ADD_DBLE_REV, DATE_OPERATOR_ADD_SNGL_REV
     GENERIC            :: OPERATOR(-)      => DATE_OPERATOR_SUB_INT, DATE_OPERATOR_SUB_DBLE, DATE_OPERATOR_SUB_SNGL, &
                                               DATE_OPERATOR_SUB
