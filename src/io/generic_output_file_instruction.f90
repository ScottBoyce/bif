...
MODULE GENERIC_OUTPUT_FILE_INSTRUCTION!, ONLY: GENERIC_OUTPUT_FILE
  ...
  END SUBROUTINE
  !
  SUBROUTINE OPEN_GENERIC_OUTPUT_FILE(FL, LN, LLOC, OUTPUT, INFILE, NOSTOP, REQKEY, IU, BINARY, BUFFER, SPLIT_SIZE, NOBINARY, SPLITMAXCOUNT, NO_INTERNAL, SAVE_FNAME, KEY, DIM, PREPOST, STREAM_TEXT, NOPOSTKEY, FORCE_DATAFILE, MSG)
    ...
    LOGICAL:: ISOPEN, ALLOW_ERROR, NOREQKEY, DATAFILE, FOUND_KEY, CHECK_POST, NOT_UNIQUE, SAVE_FN
