...
MODULE UNIT_TESTING_INSTRUCTION
  ...
  TYPE UNIT_TESTS
    ...
    GENERIC            :: ASSERT        => ASSERT_UNIT_TEST_0D_CHAR,   ASSERT_UNIT_TEST_0D_INT8, ASSERT_UNIT_TEST_0D_INT16, &
                                           ASSERT_UNIT_TEST_0D_INT32, ASSERT_UNIT_TEST_0D_INT64, ASSERT_UNIT_TEST_0D_REL32, &
                                           ASSERT_UNIT_TEST_0D_REL64,    ASSERT_UNIT_TEST_0D_TF,  ASSERT_UNIT_TEST_0D_TFOP, &
                                           ASSERT_UNIT_TEST_1D_CHAR,   ASSERT_UNIT_TEST_1D_INT8, ASSERT_UNIT_TEST_1D_INT16, &
                                           ASSERT_UNIT_TEST_1D_INT32, ASSERT_UNIT_TEST_1D_INT64, ASSERT_UNIT_TEST_1D_REL32, &
                                           ASSERT_UNIT_TEST_1D_REL64,    ASSERT_UNIT_TEST_1D_TF,  ASSERT_UNIT_TEST_1D_TFOP, &
                                           ASSERT_UNIT_TEST_2D_CHAR,   ASSERT_UNIT_TEST_2D_INT8, ASSERT_UNIT_TEST_2D_INT16, &
                                           ASSERT_UNIT_TEST_2D_INT32, ASSERT_UNIT_TEST_2D_INT64, ASSERT_UNIT_TEST_2D_REL32, &
                                           ASSERT_UNIT_TEST_2D_REL64,    ASSERT_UNIT_TEST_2D_TF,  ASSERT_UNIT_TEST_2D_TFOP, &
                                           ASSERT_UNIT_TEST_0D_NONZERO_INT8,  ASSERT_UNIT_TEST_0D_NONZERO_INT16,            &
                                           ASSERT_UNIT_TEST_0D_NONZERO_INT32, ASSERT_UNIT_TEST_0D_NONZERO_INT64,            &
                                           ASSERT_UNIT_TEST_1D_NONZERO_INT8,  ASSERT_UNIT_TEST_1D_NONZERO_INT16,            &
                                           ASSERT_UNIT_TEST_1D_NONZERO_INT32, ASSERT_UNIT_TEST_1D_NONZERO_INT64,            &
                                           ASSERT_UNIT_TEST_2D_NONZERO_INT8,  ASSERT_UNIT_TEST_2D_NONZERO_INT16,            &
                                           ASSERT_UNIT_TEST_2D_NONZERO_INT32, ASSERT_UNIT_TEST_2D_NONZERO_INT64
    ...
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_INT32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_INT64
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_REL32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_REL64
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_TF
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_TFOP
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_CHAR
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_INT8
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_INT16
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_INT32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_INT64
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_REL32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_REL64
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_TF
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_TFOP
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_CHAR
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_INT8
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_INT16
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_INT32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_INT64
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_REL32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_REL64
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_TF
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_TFOP
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_CHAR
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_INT8
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_INT16
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_NONZERO_INT8
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_NONZERO_INT16
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_NONZERO_INT32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_0D_NONZERO_INT64
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_NONZERO_INT8
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_NONZERO_INT16
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_NONZERO_INT32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_1D_NONZERO_INT64
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_NONZERO_INT8
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_NONZERO_INT16
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_NONZERO_INT32
    PROCEDURE, pass(UT), PRIVATE:: ASSERT_UNIT_TEST_2D_NONZERO_INT64
    !
    ! ---------------------------- Final Routine ------------------------------------------------------------------------------------------
  ...
  SUBROUTINE GET_DOUBLE_VEC(LN, LOC, ISTART, ISTOP, VAL, ERROR_VAL, IOSTAT, COM)
    ...
    DO I=ONE,SIZE(VAL)
              ...
              IF(IERR.NE.Z .OR. LN(ISTART:ISTOP)==BLNK) THEN
                    ...
                    !
                    IF(MUST_STOP) THEN
                        ERRMSG = 'GET_VALUE READ UTILITY ERROR: FAILED TO CONVERT TEXT TO DOUBLE PRECISION NUMBER.'//NL//NL// &
                                 'THE FOLLOWING IS THE TEXT ATTEMPTED TO BE CONVERTED "'//LN(ISTART:ISTOP)//'".'//NL// &
                                 '(IF THIS IS BLANK/EMPTY THEN YOU MAY NOT HAVE ENOUGH NUMBERS SPECIFIED ON THE LINE)'
                        IF(LN(ISTART:ISTOP)==BLNK) ERRMSG = ERRMSG//NL//NL//&
                                                   'THE POSSIBLE REASON FOR THIS ERROR IS DUE TO READING in A '// &
                                                   'BLANK/EMPTY LINE OR YOU DID NOT PROVIDE ENOUGH NUMBERS ON THE LINE.'
                        !
  ...
  SUBROUTINE GET_DOUBLE_VAL(LN, LOC, ISTART, ISTOP, VAL, ERROR_VAL, IOSTAT, COM)
    ...
    IF(IERR.NE.Z .OR. LN(ISTART:ISTOP)==BLNK) THEN
          ...
          IF(CHECK) THEN
              ERRMSG = 'GET_VALUE READ UTILITY ERROR: FAILED TO CONVERT TEXT TO DOUBLE PRECISION NUMBER.'//NL//NL//&
                       'THE FOLLOWING IS THE TEXT ATTEMPTED TO BE CONVERTED "'//LN(ISTART:ISTOP)//'".'
              IF(LN(ISTART:ISTOP)==BLNK) ERRMSG = ERRMSG//NL//NL//&
                  'THE POSSIBLE REASON FOR THIS ERROR IS DUE TO READING in A '// &
              'BLANK/EMPTY LINE OR YOU DID NOT PROVIDE ENOUGH NUMBERS ON THE LINE.'
              !
  ...
  SUBROUTINE GET_INTEGER_VEC(LN, LOC, ISTART, ISTOP, VAL, ERROR_VAL, IOSTAT, COM)
    ...
    DO I=ONE,SIZE(VAL)
              ...
              IF(IERR.NE.Z .OR. LN(ISTART:ISTOP)==BLNK) THEN
                    ...
                    IF(MUST_STOP) THEN
                        IERR = SIZE(VAL)
                        ERRMSG = 'GET_VALUE READ UTILITY ERROR: EXPECTED TO READ '//INT2STR(IERR)//&
                                 ' INTEGERS, BUT FAILED TO CONVERT THE POSITION '//INT2STR(I)//&
                                 ' TEXT TO INTEGER.'//NL//NL//'THE FOLLOWING IS THE TEXT ATTEMPTED TO BE CONVERTED "'//&
                                 LN(ISTART:ISTOP)//'".'//NL//&
                                 '(IF THIS IS BLANK/EMPTY THEN YOU MAY NOT HAVE ENOUGH NUMBERS SPECIFIED ON THE LINE)'
                        IF(LN(ISTART:ISTOP)==BLNK) ERRMSG = ERRMSG//NL//NL//&
                                                   'THE POSSIBLE REASON FOR THIS ERROR IS DUE TO READING in A '// &
  ...
  SUBROUTINE GET_INTEGER_VAL(LN, LOC, ISTART, ISTOP, VAL, ERROR_VAL, IOSTAT, COM)
    ...
    IF(IERR.NE.Z .OR. LN(ISTART:ISTOP)==BLNK) THEN
          ...
          !
          IF(CHECK) THEN
              ERRMSG = 'GET_VALUE READ UTILITY ERROR: FAILED TO CONVERT TEXT TO INTEGER NUMBER.'//NL//NL//&
                       'THE FOLLOWING IS THE TEXT ATTEMPTED TO BE CONVERTED "'//LN(ISTART:ISTOP)//'".'
              IF(LN(ISTART:ISTOP)==BLNK) ERRMSG = ERRMSG//NL//NL//&
                                         'THE POSSIBLE REASON FOR THIS ERROR IS DUE TO READING in A '// &
                                         'BLANK/EMPTY LINE OR YOU DID NOT PROVIDE ENOUGH NUMBERS ON THE LINE.'
  ...
  SUBROUTINE GET_REAL_VEC(LN, LOC, ISTART, ISTOP, VAL, ERROR_VAL, IOSTAT, COM)
    ...
    DO I=ONE,SIZE(VAL)
              ...
              IF(IERR.NE.Z .OR. LN(ISTART:ISTOP)==BLNK) THEN
                    ...
                    !
                    IF(MUST_STOP) THEN
                        ERRMSG = 'GET_VALUE READ UTILITY ERROR: FAILED TO CONVERT TEXT TO SINGLE PRECISION NUMBER.'//NL//NL//&
                                 'THE FOLLOWING IS THE TEXT ATTEMPTED TO BE CONVERTED "'//LN(ISTART:ISTOP)//'".'//NL//&
                                 '(IF THIS IS BLANK/EMPTY THEN YOU MAY NOT HAVE ENOUGH NUMBERS SPECIFIED ON THE LINE)'
                        IF(LN(ISTART:ISTOP)==BLNK) ERRMSG = ERRMSG//NL//NL//&
                                                   'THE POSSIBLE REASON FOR THIS ERROR IS DUE TO READING in A '// &
